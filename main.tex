\documentclass[10pt, english]{book}              % Book class in 11 points
...
\title{\bf First Steps in Motivic Homotopy Theory}    % Supply information
...
\chapter{Lecture 1: Introduction}                % Print a "chapter" heading
